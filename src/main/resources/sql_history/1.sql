...
CREATE TABLE card(
	card_id BIGINT PRIMARY KEY generated by default as identity,
...
CREATE TABLE deck(
	deck_id BIGINT PRIMARY KEY generated by default as identity,
...
CREATE TABLE user_deck(
	user_deck_id BIGINT PRIMARY KEY generated by default as identity,
	deck_id BIGINT references deck(deck_id) NOT NULL,
	owned_by BIGINT references app_user(user_id) NOT NULL,
	created TIMESTAMPTZ NOT NULL default current_timestamp
)
...
CREATE SEQUENCE card_seq START WITH 100000000 INCREMENT BY 1;

insert into app_user(username, user_id)
